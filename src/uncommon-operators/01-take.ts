...
// setTimeout(() => {
//   // console.log("unsubscribe subscription connect");
//   // subscriptionConnect.unsubscribe();

//   // console.log("unsubscribe subscription 1");
//   // subscription1.unsubscribe();
//   // console.log("unsubscribe subscription 2");
//   // subscription2.unsubscribe();

//   // Source observable keeps pushing data
